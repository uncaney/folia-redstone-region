...
public class WireHandler {
	...
	/**
	 * Retrieve the {@link net.ekaii.redstone.region.ac.Node Node} that represents the
	...
	/**
	 * Remove and return the {@link net.ekaii.redstone.region.ac.Node Node} at the given
	 * position.
	 */
	 ...
	 * wire, then create a new {@link net.ekaii.redstone.region.ac.WireNode WireNode}.
	 * Otherwise, grab the next {@link net.ekaii.redstone.region.ac.Node Node} from the
	 * cache and update it.
	 */
